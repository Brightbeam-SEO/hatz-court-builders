          ...
          <div className="flex flex-1 items-center justify-center bg-gray-50/50 p-2 sm:p-3 md:p-4">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                onClick={onClose}
              >
                <MediaItem item={selectedItem} className="h-full w-full object-contain bg-gray-900/20" onClick={onClose} />
...
export default function InteractiveBentoGallery({
  ...
  return (
    <div className={`mx-auto max-w-4xl px-4 py-8 ${className}`.trim()}>
      {showHeader && (title || description) ? (
        <div className="mb-8 text-center">
          {title ? (
            <motion.h1
              className="bg-gradient-to-r from-white via-white/95 to-white/90 bg-clip-text text-2xl font-bold text-transparent sm:text-3xl md:text-4xl"
