...
const brutalMotionClass =
  "transition-all duration-200 ease-in-out shadow-[4px_4px_0px_var(--btn-shadow)] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_var(--btn-shadow)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none motion-reduce:transform-none motion-reduce:shadow-[4px_4px_0px_var(--btn-shadow)]";
  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center px-6 py-3 font-bold",
          hasBorder ? "border-2" : "border-0",
          hasShadow ? brutalMotionClass : "active:scale-95",
          className,
        )}
        style={customStyles}
        {...props}
  ...
  (
    ...
    return (
      <a
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center px-6 py-3 font-bold no-underline",
          hasBorder ? "border-2" : "border-0",
          hasShadow ? brutalMotionClass : "active:scale-95",
          className,
        )}
