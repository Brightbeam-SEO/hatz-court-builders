...
export const PM_SERVICE_PAGES: Record<string, PmServicePageEntry> = {
  ...
  "basketball-court-installation-scottsdale-az": {
    ...
    config: PM_BASKETBALL_COURT_INSTALLATION_SCOTTSDALE_AZ_CONFIG,
    fallbackMarkdownPath: "content/services/basketball-court-installation-scottsdale-az-body.md",
    sanitySlug: "basketball-court-installation-scottsdale-az",
  },
  "pickleball-court-installation-scottsdale-az": {
    slug: "pickleball-court-installation-scottsdale-az",
    config: PM_PICKLEBALL_COURT_INSTALLATION_SCOTTSDALE_AZ_CONFIG,
    fallbackMarkdownPath: "content/services/pickleball-court-installation-scottsdale-az-body.md",
    sanitySlug: "pickleball-court-installation-scottsdale-az",
  },
  "bocce-court-builder-scottsdale-az": {
    slug: "bocce-court-builder-scottsdale-az",
    config: PM_BOCCE_COURT_BUILDER_SCOTTSDALE_AZ_CONFIG,
    fallbackMarkdownPath: "content/services/bocce-court-builder-scottsdale-az-body.md",
    sanitySlug: "bocce-court-builder-scottsdale-az",
  },
  "padel-court-builder-scottsdale-az": {
    slug: "padel-court-builder-scottsdale-az",
    config: PM_PADEL_COURT_BUILDER_SCOTTSDALE_AZ_CONFIG,
    fallbackMarkdownPath: "content/services/padel-court-builder-scottsdale-az-body.md",
    sanitySlug: "padel-court-builder-scottsdale-az",
  },
  ...
  "pickleball-court-builders-mesa-az": {
    slug: "pickleball-court-builders-mesa-az",
    config: PM_PICKLEBALL_COURT_BUILDERS_MESA_AZ_CONFIG,
    fallbackMarkdownPath: "content/services/pickleball-court-builders-mesa-az-body.md",
    sanitySlug: "pickleball-court-builders-mesa-az",
  },
  ...
  "asphalt-court-installation": {
    ...
    config: PM_ASPHALT_COURT_INSTALLATION_CONFIG,
    fallbackMarkdownPath: "content/services/asphalt-court-installation-body.md",
    sanitySlug: "asphalt-court-installation",
  },
  "concrete-court-installation": {
    slug: "concrete-court-installation",
    config: PM_CONCRETE_COURT_INSTALLATION_CONFIG,
    fallbackMarkdownPath: "content/services/concrete-court-installation-body.md",
    sanitySlug: "concrete-court-installation",
  },
  "acrylic-court-systems": {
    slug: "acrylic-court-systems",
    config: PM_ACRYLIC_COURT_SYSTEMS_CONFIG,
    fallbackMarkdownPath: "content/services/acrylic-court-systems-body.md",
    sanitySlug: "acrylic-court-systems",
  },
  "synthetic-courts": {
    slug: "synthetic-courts",
    config: PM_SYNTHETIC_COURTS_CONFIG,
    fallbackMarkdownPath: "content/services/synthetic-courts-body.md",
    sanitySlug: "synthetic-courts",
  },
  "modular-court-surfaces": {
    slug: "modular-court-surfaces",
    config: PM_MODULAR_COURT_SURFACES_CONFIG,
    fallbackMarkdownPath: "content/services/modular-court-surfaces-body.md",
    sanitySlug: "modular-court-surfaces",
  },
  "cushioned-court-systems": {
    slug: "cushioned-court-systems",
    config: PM_CUSHIONED_COURT_SYSTEMS_CONFIG,
    fallbackMarkdownPath: "content/services/cushioned-court-systems-body.md",
    sanitySlug: "cushioned-court-systems",
  },
  "indoor-sports-flooring": {
    slug: "indoor-sports-flooring",
    config: PM_INDOOR_SPORTS_FLOORING_CONFIG,
    fallbackMarkdownPath: "content/services/indoor-sports-flooring-body.md",
    sanitySlug: "indoor-sports-flooring",
  },
};
