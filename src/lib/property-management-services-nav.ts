...
const SERVICE_LABELS: Record<PropertyManagementServiceSlug, string> = {
  ...
  "pickleball-court-installation-scottsdale-az": "Pickleball Court Installation Scottsdale, AZ",
  ...
  "pickleball-court-builders-mesa-az": "Pickleball Court Builders Mesa, AZ",
